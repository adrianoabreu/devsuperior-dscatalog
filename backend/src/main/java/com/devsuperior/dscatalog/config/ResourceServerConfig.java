...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	private static final String[] ADMIN = {"/users/**"}; // definição das rotas disponíveis para login administrador.
	...
	// As configurações abaixo estão definindo a configurações do Cors, que permitem origens externas permitidas a acessar a aplicação DSCatalog.
	@Bean
